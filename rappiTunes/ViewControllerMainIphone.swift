//
//  ViewControllerMainIphone.swift
//  rappiTunes
//
...
class ViewControllerMainIphone: UIViewController,UITableViewDataSource, UITableViewDelegate {

    @IBOutlet weak var viewTransitionAnimate: UIView!
    ...
    override func viewDidLoad() {
        ...
        self.viewTransitionAnimate.alpha = 0
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        UIView.animate(withDuration: 1, animations: {
            ...
            self.viewTransitionAnimate.layer.cornerRadius = self.viewTransitionAnimate.bounds.size.width / 2.0
            self.viewTransitionAnimate.clipsToBounds = true
            
            self.viewTransitionAnimate.transform = CGAffineTransform(scaleX:0.1,y: 0.1)
            self.viewTransitionAnimate.alpha = 0;
        })
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! TableViewCellCategory
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: 1.0, animations: {
            ...
            self.viewTransitionAnimate.transform = CGAffineTransform(scaleX: 700,y: 700)
            self.viewTransitionAnimate.alpha = 1;
    ...
    func segueClick() {
        ...
        self.performSegue(withIdentifier: "app", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "app" {
            ...
            viewController.categoriaSegue = self.catRow as String
